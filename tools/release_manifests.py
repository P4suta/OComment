...
def main() -> int:
    ...
    # NOTE: The release workflow passes $GITHUB_REPOSITORY; the default is for a person generating the definitions by hand, and it has to name the repository the archives are actually published from.
