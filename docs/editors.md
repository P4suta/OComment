...
The extension is currently source-only and is not distributed through the Visual Studio Marketplace, Open VSX, or GitHub Releases.
To build a local VSIX from a checkout:
...
The source and its development notes are under [`editors/vscode`](https://github.com/P4suta/OComment/blob/main/editors/vscode/README.md).
