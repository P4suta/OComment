...
Kotlin, TOML, Lua, YAML, and PHP — including the JSX/TSX, Objective-C/C++, and
CUDA dialects.
...
| `ocomment.languages` | the 24 identifiers above | Which language identifiers the server is attached to. |
