        ...
        ocomment)
            ...
            case "${prev}" in
                ...
                --layout)
                    ...
                    ;;
                --language)
                    COMPREPLY=($(compgen -W "rust ocaml c cpp go java javascript typescript python shell html css jsonc sql kotlin toml lua yaml php ruby zig r dart swift csharp scala vue svelte markdown" -- "${cur}"))
                    return 0
                    ;;
                --dialect)
