...
set edit:completion:arg-completer[ocomment] = {|@words|
    ...
    var completions = [
        &'ocomment'= {
            ...
            cand --progress 'Accepted for compatibility; the end-of-run summary replaced this line'
            ...
            cand -q 'Print nothing but errors and diagnostics'
            cand --quiet 'Print nothing but errors and diagnostics'
