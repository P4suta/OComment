...
Register-ArgumentCompleter -Native -CommandName 'ocomment' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'ocomment' {
            ...
            [CompletionResult]::new('--deny-skipped', '--deny-skipped', [CompletionResultType]::ParameterName, 'Fail when a file was passed over for one of these reasons, rather than noting it. With no reason given, the two that are holes rather than decisions: unknown-language and unreadable')
            ...
            [CompletionResult]::new('tags', 'tags', [CompletionResultType]::ParameterValue, 'Count the tags this tree''s comments open with, against the ones it allows')
        ...
        'ocomment;fix' {
            ...
            [CompletionResult]::new('--tidy', '--tidy', [CompletionResultType]::ParameterName, 'Apply what the style rules rewrote and leave every removal to you')
        ...
        'ocomment;init' {
            ...
            [CompletionResult]::new('--jobs', '--jobs', [CompletionResultType]::ParameterName, 'How many threads the run uses to walk, read and scan; 0 chooses one per core')
            [CompletionResult]::new('--summary', '--summary', [CompletionResultType]::ParameterName, 'Also write the end-of-run counts to this file, as one JSON object')
            [CompletionResult]::new('--tidy', '--tidy', [CompletionResultType]::ParameterName, 'For the Lefthook hook, run `fix --tidy` instead of `check`')
