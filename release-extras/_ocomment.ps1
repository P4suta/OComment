...
Register-ArgumentCompleter -Native -CommandName 'ocomment' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'ocomment' {
            ...
            [CompletionResult]::new('--progress', '--progress', [CompletionResultType]::ParameterName, 'Accepted for compatibility; the end-of-run summary replaced this line')
            ...
            [CompletionResult]::new('-q', '-q', [CompletionResultType]::ParameterName, 'Print nothing but errors and diagnostics')
            [CompletionResult]::new('--quiet', '--quiet', [CompletionResultType]::ParameterName, 'Print nothing but errors and diagnostics')
